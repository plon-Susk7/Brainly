        ...
        <>
            <div className="fixed inset-0 z-50 flex items-center justify-center">
                <div className="h-[400px] w-[300px] bg-gray-200 flex flex-col items-center justify-center gap-3 p-4">
                    ...
                    <input name="username" type="text" className="w-full mb-2 p-1 rounded-lg border border-gray-300" />
                    <h1>Enter password</h1>
                    <input name="password" type="password" className="w-full mb-2 p-1 rounded-lg border border-gray-300" />
